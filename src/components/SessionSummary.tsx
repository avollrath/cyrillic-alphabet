      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
        <div className="relative overflow-hidden rounded-3xl bg-surface-container-lowest p-8 md:col-span-8 md:p-12">
          ...
          <div className="relative z-10">
            ...
            <p className="mb-8 max-w-md text-lg leading-relaxed text-on-surface-variant">
              Hervorragende Arbeit. Du hast die kyrillischen Nuancen dieser Lektion mit bemerkenswerter Präzision gemeistert.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row">
              <button
                type="button"
                onClick={onNextRound}
                className="bg-primary-gradient flex items-center justify-center gap-2 rounded-xl px-8 py-4 font-headline text-lg font-bold text-on-primary"
              >
                Nächste Runde
              ...
              <button
                type="button"
                onClick={onDashboard}
                className="rounded-xl bg-surface px-8 py-4 font-headline text-lg font-bold text-on-surface"
              >
                Zum Dashboard
              </button>
            </div>
        ...
        <div className="flex flex-col gap-6 md:col-span-4">
          <div className="rounded-3xl bg-surface-container-lowest p-8 text-center">
            ...
            <p className="mt-1 text-sm text-on-surface-variant">{completion}% der Galerie gemeistert.</p>
          </div>
          <div className="rounded-3xl bg-surface-container-low p-6">
            <div className="grid gap-4">
              <div className="flex items-center gap-4 rounded-2xl bg-surface-container-lowest p-4">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-on-surface-variant">XP verdient</p>
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-surface-container-lowest p-4">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-on-surface-variant">Genauigkeit</p>
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-surface-container-lowest p-4">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-on-surface-variant">Meisterhaft</p>
